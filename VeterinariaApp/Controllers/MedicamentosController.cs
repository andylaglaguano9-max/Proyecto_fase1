...
namespace VeterinariaApp.Controllers
{
    public class MedicamentosController : Controller
    {
        ...
        public async Task<IActionResult> Index(string orden, string buscar, int pagina = 1)
        {
            ...
            var query = _context.Medicamentos.Where(e => e.Activo).AsQueryable();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, Medicamento entity)
        {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var entity = await _context.Medicamentos.FirstOrDefaultAsync(m => m.Id == id && m.Activo);
