...
namespace VeterinariaApp.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public async Task<IActionResult> Index(string orden, string buscar, int pagina = 1)
        {
            ...
            var query = _context.Proveedores.Where(e => e.Activo).AsQueryable();
        ...
        public async Task<IActionResult> Create(Proveedor entity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, Proveedor entity)
        {
            if (id != entity.Id) return NotFound();

            if (ModelState.IsValid)
            {
                var original = await _context.Proveedores.FindAsync(id);
                if (original != null)
                {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var entity = await _context.Proveedores.FirstOrDefaultAsync(m => m.Id == id && m.Activo);
